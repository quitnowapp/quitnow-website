    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function setBodyClass(){
            ...
            document.childNodes[1].className = document.childNodes[1].className.replace(classRe, '');

            //adding the current anchor
            $(document.childNodes[1]).addClass(VIEWING_PREFIX + '-' + text);
        }
